        ...
        <footer className="bg-black text-white pt-20 pb-10">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    <div className="space-y-6">
                        ...
                        <p className="text-gray-400 leading-relaxed">
                            Empowering knowledge growth through a complete learning ecosystem for instructors and learners worldwide.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-gray-400 font-medium">
                            <li><a href="#features" className="hover:text-brand-blue transition-colors">Portals</a></li>
                            <li><a href="#pricing" className="hover:text-brand-blue transition-colors">Access Rules</a></li>
                            <li><a href="#" className="hover:text-brand-blue transition-colors">LMS Sync</a></li>
                    ...
                    <div>
                        ...
                        <p className="text-gray-400 mb-6 font-medium">Get the latest updates on course building and educational trends.</p>
                ...
                <div className="border-t border-white/5 pt-10 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-500">
                    <div>© 2026 LearnSphere. All rights reserved.</div>
