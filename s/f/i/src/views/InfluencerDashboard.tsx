...
import { Search, LayoutGrid, List as ListIcon, Plus, Share2, Edit3, Trash2, X, Video, Clock, Eye, Users, PlayCircle, CheckCircle, Circle, Filter, User, Mail, Shield, Camera } from 'lucide-react';
                                            ...
                                            <div className={`relative z-20 flex flex-col h-full p-8 ${course.image ? 'text-white' : 'text-gray-900'}`}>
                                                ...
                                                <div className="flex justify-between items-start mb-auto">
                                                    ...
                                                    <div className="flex gap-2">
                                                        ...
                                                        <button
                                                            className={`w-10 h-10 flex items-center justify-center rounded-xl backdrop-blur-md transition-all ${course.image
                                                                ? 'bg-black/20 hover:bg-red-500 text-white hover:text-white border border-white/10'
