...
export const Register = () => {
    ...
    const handleRegister = async (e: React.FormEvent) => {
        ...
        const role = 'company'; // Mapping Learner to company role for frontend

        try {
            const response = await fetch('http://127.0.0.1:5000/api/register/learner', {
                method: 'POST',
            ...
            if (response.ok) {
                ...
                localStorage.setItem('botfree_token', `learner_token_${data.id}`);
