...
const EditContent = () => {
    ...
    // Determine if this is a quiz based on contentId (mock logic)
    const isQuiz = parseInt(contentId || '1') === 3 || parseInt(contentId || '1') === 6;

    // Mock data - in real app, this would be fetched based on contentId
    const [contentData, setContentData] = useState({
        id: parseInt(contentId || '1'),
        title: isQuiz ? 'State Management Quiz' : 'Introduction to React',
        type: (isQuiz ? 'quiz' : 'video') as 'video' | 'quiz',
        duration: isQuiz ? '10 mins' : '15 mins',
        description: isQuiz
            ? 'Test your knowledge of React state management concepts.'
            : 'Learn the fundamentals of React including components, props, and state management.',
        url: isQuiz ? '' : 'https://youtube.com/watch?v=example',
