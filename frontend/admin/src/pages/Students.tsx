...
const Learners = () => {
            ...
            try {
                ...
                const data = res.data.map((user: any) => {
                    return {
                        ...
                        email: user.email,
                        role: 'Student',
                        status: 'active', // Default to active as schema doesn't support status
                        coursesEnrolled: parseInt(user.enrolled_courses) || 0,
                        ...
                        location: 'Online',
                        avatarVal: user.name ? user.name.charAt(0).toUpperCase() : 'U'
                    };
                });
                setStudents(data);
                setLoading(false);
    ...
    if (loading) {
        return <div className="min-h-screen flex items-center justify-center">Loading Learners...</div>;
    }
