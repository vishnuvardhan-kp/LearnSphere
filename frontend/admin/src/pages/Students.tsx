            ...
            <header className="bg-white/80 backdrop-blur-xl border-b border-gray-200 sticky top-0 z-40 transition-all duration-200">
                <div className="max-w-7xl mx-auto px-6 py-4">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <div>
                            <h1 className="text-xl font-bold text-gray-900 tracking-tight">Students</h1>
                            <p className="text-xs text-gray-500 font-medium mt-0.5">Manage student profiles and progress</p>
                        </div>
            ...
            <div className="max-w-7xl mx-auto px-6 py-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
                        <div className="flex justify-between items-start mb-4">
                            <div>
                                ...
                                <h3 className="text-3xl font-black text-gray-900 mt-1">{mockStudents.length}</h3>
                            </div>
                        ...
                        <div className="flex justify-between items-start mb-4">
                            <div>
                                ...
                                <h3 className="text-3xl font-black text-gray-900 mt-1">
                                    {mockStudents.filter(s => s.status === 'active' || s.status === 'offline').length}
                                </h3>
                            </div>
                    ...
                    <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
                        <div className="flex justify-between items-start mb-4">
                            <div>
                                <p className="text-xs font-bold text-gray-500 uppercase tracking-widest">Course Completion</p>
                                <h3 className="text-3xl font-black text-gray-900 mt-1">85%</h3>
                            </div>
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full">
                            <thead className="bg-gray-50/80 border-b border-gray-200">
                                <tr>
                                    <th className="text-left py-3 px-6 font-bold text-gray-500 text-[10px] uppercase tracking-widest">Student Name</th>
