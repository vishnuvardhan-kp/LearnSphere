...
const mockParticipants: Participant[] = [
    { id: 1, name: 'John Doe', course: 'Introduction to React', progress: 75, status: 'in-progress' },
    { id: 2, name: 'Jane Smith', course: 'Advanced TypeScript', progress: 100, status: 'completed' },
    { id: 3, name: 'Mike Johnson', course: 'Node.js Fundamentals', progress: 45, status: 'in-progress' },
    { id: 4, name: 'Sarah Williams', course: 'UI/UX Design Principles', progress: 0, status: 'yet-to-start' },
    { id: 5, name: 'Tom Brown', course: 'Introduction to React', progress: 90, status: 'in-progress' },
    { id: 6, name: 'Emily Davis', course: 'Advanced TypeScript', progress: 100, status: 'completed' },
    { id: 7, name: 'Chris Wilson', course: 'Node.js Fundamentals', progress: 60, status: 'in-progress' },
    { id: 8, name: 'Lisa Anderson', course: 'Introduction to React', progress: 0, status: 'yet-to-start' },
];

const viewData = [
    { name: 'Mon', views: 4000, enrolments: 2400 },
    { name: 'Tue', views: 3000, enrolments: 1398 },
    { name: 'Wed', views: 2000, enrolments: 9800 },
    { name: 'Thu', views: 2780, enrolments: 3908 },
    { name: 'Fri', views: 1890, enrolments: 4800 },
    { name: 'Sat', views: 2390, enrolments: 3800 },
    { name: 'Sun', views: 3490, enrolments: 4300 },
];

const coursePerformanceData = [
    { name: 'React', students: 4000, completions: 2400 },
    { name: 'Node.js', students: 3000, completions: 1398 },
    { name: 'UI/UX', students: 2000, completions: 980 },
    { name: 'TypeScript', students: 2780, completions: 3908 },
];
...
const Dashboard = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50/50">
                        ...
                        <div className="flex items-center gap-4">
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="pl-9 pr-4 py-2 bg-gray-100/50 border border-transparent hover:bg-white hover:border-gray-200 focus:bg-white focus:border-[#0ea5e9] rounded-lg text-sm transition-all focus:outline-none focus:ring-4 focus:ring-[#0ea5e9]/10 w-64 text-gray-700 placeholder:text-gray-400"
                                />
                            </div>
                            <div className="h-8 w-px bg-gray-200 mx-1"></div>
                            <button
                                onClick={() => setShowNewCourseModal(true)}
                                className="btn-primary flex items-center gap-2 px-5 py-2 text-sm shadow-lg shadow-blue-500/20 hover:shadow-blue-500/30 active:scale-95"
                            >
            ...
            <div className="max-w-7xl mx-auto px-6 py-8">
                ...
                <section className="mb-10">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                        <div className="bg-white p-6 rounded-xl border border-gray-200/60 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] hover:border-[#0ea5e9]/30 transition-all group relative overflow-hidden">
                        ...
                        <div className="bg-white p-6 rounded-xl border border-gray-200/60 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] hover:border-[#6366f1]/30 transition-all group relative overflow-hidden">
                            <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                        ...
                        <div className="bg-white p-6 rounded-xl border border-gray-200/60 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] hover:border-green-500/30 transition-all group relative overflow-hidden">
                            <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                        ...
                        <div className="bg-white p-6 rounded-xl border border-gray-200/60 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] hover:border-orange-500/30 transition-all group relative overflow-hidden">
                            <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                            ...
                            <div className="flex items-baseline gap-2">
                                <h3 className="text-2xl font-bold text-gray-900">{mockCourses.length}</h3>
                    ...
                    <div className="space-y-6">
                        <div className="bg-white p-6 rounded-xl border border-gray-200/60 shadow-sm h-full">
                            ...
                            <div className="relative pl-4 border-l-2 border-gray-100 space-y-8">
                                {[
                                    { text: 'New student enrolled in React Course', time: '2 mins ago', type: 'enrollment' },
                                    { text: 'Sarah completed UI/UX Design', time: '1 hour ago', type: 'completion' },
                                    { text: 'Mike commented on "State Management"', time: '3 hours ago', type: 'comment' },
                                    { text: 'New course "Advanced Ruby" published', time: '5 hours ago', type: 'course' },
                    ...
                    {viewMode === 'kanban' && (
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                            {filteredCourses.map((course) => (
                                <div key={course.id} className="bg-white rounded-xl p-0 border border-gray-200 shadow-sm hover:shadow-md hover:border-[#0ea5e9]/50 transition-all duration-300 group cursor-pointer overflow-hidden flex flex-col">
                                    ...
                                    <div className="px-5 py-3 bg-gray-50/50 border-t border-gray-100 flex gap-3">
                                        <button className="flex-1 text-xs font-semibold text-gray-600 hover:text-[#0ea5e9] hover:bg-white border border-transparent hover:border-gray-200 py-1.5 rounded-lg transition-all flex items-center justify-center gap-1.5">
                                            ...
                                            <tr key={course.id} className="hover:bg-gray-50 transition-colors group">
                                                ...
                                                <td className="py-4 px-6 text-right">
                                                    <div className="flex justify-end gap-2">
                                                        <button className="p-1.5 hover:bg-[#0ea5e9]/10 rounded-lg text-gray-400 hover:text-[#0ea5e9] transition-colors">
            ...
            {/* New Course Modal (Unchanged logic, updated styling) */}
            {
                showNewCourseModal && (
                        ...
                        <div className="bg-white rounded-2xl p-0 w-full max-w-lg border border-gray-100 shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
                            ...
                            <div className="p-6">
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-4 focus:ring-[#0ea5e9]/10 focus:border-[#0ea5e9] text-gray-900 placeholder:text-gray-400 font-medium transition-all"
                                    autoFocus
                                    onKeyPress={(e) => e.key === 'Enter' && handleCreateCourse()}
                                />
                                <p className="mt-2 text-xs text-gray-400">This will be visible to all enrolled students.</p>
                            </div>
