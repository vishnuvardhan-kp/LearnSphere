        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 flex flex-col">
                ...
                <div className="max-w-6xl w-full">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-lg text-gray-400 font-medium max-w-2xl mx-auto">
                            Discover how Vyral AI is revolutionizing influencer marketing with authentic engagement and bot-free campaigns.
                        </p>
                    </div>
                    ...
                    <div className="relative rounded-3xl overflow-hidden shadow-2xl shadow-brand-blue/20 border border-white/10 bg-black group">
                        ...
                        <video
                            ...
                            onClick={togglePlay}
                        >
                            <source src="/Vyral_AI_Bot_Fraud_Protection.mp4" type="video/mp4" />
            ...
            <footer className="p-6 text-center">
                <p className="text-gray-500 text-sm font-medium">
                    © 2026 Vyral AI. Authentic Engagement, Real Results.
                </p>
            </footer>
        </div>
    );
