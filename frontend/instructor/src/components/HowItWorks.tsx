...
const steps = [
    {
        number: '01',
        title: 'Learn',
        description: 'Browse courses and engage with rich content including video, documents, and images in a professional player.',
        icon: Globe,
    ...
    },
    {
        number: '02',
        title: 'Challenge',
        description: 'Attempt interactive quizzes with multiple attempts and earn points based on your performance and speed.',
        icon: Handshake,
    ...
    },
    {
        number: '03',
        title: 'Achieve',
        description: "Level up from Newbie to Master through earned badges and complete courses to unlock certifications.",
        icon: TrendingUp,
        ...
        <section id="how-it-works" className="py-32 bg-[#F8FAFC] relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="text-center mb-24">
                    <h2 className="text-brand-blue font-black tracking-[0.2em] uppercase text-xs mb-4">Progression Loop</h2>
                    <p className="text-5xl font-black text-gray-900 mb-6 tracking-tighter">The Gamification Flywheel</p>
                    <p className="text-xl text-gray-500 max-w-2xl mx-auto font-medium leading-relaxed">
                        A seamless three-step flow designed to encourage continuous learning and skill mastery.
                    </p>
                </div>
                ...
                <div className="mt-24 p-12 glass rounded-3xl border border-gray-100 flex flex-col md:flex-row items-center justify-between gap-10 shadow-premium">
                    <div className="flex items-center gap-6">
                        ...
                        <div>
                            <div className="text-xl font-black text-gray-900 tracking-tight">Unified Learning Layer</div>
                            <div className="text-sm font-medium text-gray-400">Where teaching excellence meets interactive mastery.</div>
                        </div>
                    </div>
